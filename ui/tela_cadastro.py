...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3.setGeometry(QRect(150, 10, 101, 16))
        self.lineEdit = QLineEdit(Dialog)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(70, 40, 133, 20))
        self.label = QLabel(Dialog)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(20, 40, 37, 20))
        self.lineEdit_2 = QLineEdit(Dialog)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(70, 70, 301, 20))
        self.label_2 = QLabel(Dialog)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(18, 70, 46, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Novo procedimento", None))
